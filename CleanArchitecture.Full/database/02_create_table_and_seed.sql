...
INSERT INTO accounts (id, account_number, holder_name, balance, status, created_at) VALUES
    ('a1a1a1a1-0001-0001-0001-000000000001', 'ACC-0001', 'Ada Lovelace',  15000.50, 'Active',   NOW()),
    ('a1a1a1a1-0002-0002-0002-000000000002', 'ACC-0002', 'Alan Turing',    8320.00, 'Active',   NOW()),
    ('a1a1a1a1-0003-0003-0003-000000000003', 'ACC-0003', 'Grace Hopper',      0.00, 'Inactive', NOW());
